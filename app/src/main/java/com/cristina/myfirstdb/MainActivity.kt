...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        recyclerContacts = findViewById<RecyclerView>(R.id.recycler_contacts)
    ...
    override fun onResume() {
        ...
        cursor.use {
            ...
            while (cursor.moveToNext()){
                ...
                val lastName = cursor.getString(cursor.getColumnIndex(COLUM_LASTNAME))
                val age = cursor.getInt(cursor.getColumnIndex(COLUM_AGE))
